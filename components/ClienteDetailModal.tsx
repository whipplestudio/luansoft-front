...
import { Eye, Download, FileText, Loader2, Calendar, Building2, User, Mail, Phone, Clock, CheckCircle2 } from "lucide-react"
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[95vw] lg:max-w-[1200px] max-h-[95vh] overflow-y-auto bg-gradient-to-b from-white to-gray-50/50">
        ...
        <div className="grid gap-5">
          ...
          {/* Tax Indicators - Reusable Component */}
          {client?.company && <FiscalIndicators clientCompany={client.company} />}
